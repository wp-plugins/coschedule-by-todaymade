                    ...
                    <tr valign="middle">
                        <td>
                            <div id="tm_deactivate" style="display:none;">
                                <img src="<?php echo $this->assets.'/img/vector-editorial-calendar-ready.png';?>" class="calendar-image" alt="Your CoSchedule Calendar Is Ready"/>
