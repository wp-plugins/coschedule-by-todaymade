...
?>
    <iframe id="CoSiFrame" frameborder=0 border=0 src="https://dgp49e2avkx9v.cloudfront.net/#/<?php echo get_option('tm_coschedule_token'); ?>/<?php echo get_current_user_id(); ?>/0/help" width="100%"></iframe>
